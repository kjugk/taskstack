...
const Terms: React.SFC = (props) => (
  <Container>
    ...
    <section style={{ marginBottom: '2rem' }}>
      <Header as="h3">第3条（ユーザーIDおよびパスワードの管理）</Header>
      <ol>
        <li>
    ...
    <section style={{ marginBottom: '2rem' }}>
      <Header as="h3">第5条（本サービスの提供の停止等）</Header>
      <ol>
        <li>
    ...
    <section style={{ marginBottom: '2rem' }}>
      <Header as="h3">第6条（利用制限および登録抹消）</Header>
      <ol>
        <li>
    ...
    <section style={{ marginBottom: '2rem' }}>
      <Header as="h3">第8条（サービス内容の変更等）</Header>
      <p>
    ...
    <section style={{ marginBottom: '2rem' }}>
      <Header as="h3">第9条（利用規約の変更）</Header>
      <p>
    ...
    <section style={{ marginBottom: '2rem' }}>
      <Header as="h3">第10条（通知または連絡）</Header>
      <p>ユーザーと運営者との間の通知または連絡は，運営者の定める方法によって行うものとします。</p>
    </section>

    <section style={{ marginBottom: '2rem' }}>
      <Header as="h3">第11条（権利義務の譲渡の禁止）</Header>
      <p>
    ...
    <section style={{ marginBottom: '2rem' }}>
      <Header as="h3">第12条（準拠法・裁判管轄）</Header>
      <ol>

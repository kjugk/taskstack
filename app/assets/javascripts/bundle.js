...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/client/index.tsx");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/client/constants/index.ts":
/*!***************************************!*\
  !*** ./app/client/constants/index.ts ***!
  \***************************************/
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.TASKLIST_LIST_FETCH = 'TASKLIST_LIST_FETCH';
exports.TASKLIST_LIST_FETCH_SUCCESS = 'TASKLIST_LIST_FETCH_SUCCESS';


/***/ }),

/***/ "./app/client/containers/AppContainer/index.tsx":
/*!******************************************************!*\
  !*** ./app/client/containers/AppContainer/index.tsx ***!
  \******************************************************/
/*! no static exports found */
...
var configureStore_1 = __webpack_require__(/*! ../../store/configureStore */ "./app/client/store/configureStore.ts");
var DashboardContainer_1 = __webpack_require__(/*! ../DashboardContainer */ "./app/client/containers/DashboardContainer/index.tsx");
var AppContainer = /** @class */ (function (_super) {
    ...
    AppContainer.prototype.render = function () {
        return (React.createElement(react_redux_1.Provider, { store: configureStore_1.configureStore() },
            React.createElement(DashboardContainer_1.DashboardContainer, null),
            ";"));
    };
    return AppContainer;
}(React.Component));
...
/***/ "./app/client/containers/DashboardContainer/index.tsx":
/*!************************************************************!*\
  !*** ./app/client/containers/DashboardContainer/index.tsx ***!
  \************************************************************/
/*! no static exports found */
...
var AppContainer_1 = __webpack_require__(/*! ./containers/AppContainer */ "./app/client/containers/AppContainer/index.tsx");
ReactDOM.render(React.createElement(AppContainer_1.AppContainer, null), document.getElementById('app'));


/***/ }),

/***/ "./app/client/reducers/index.ts":
/*!**************************************!*\
  !*** ./app/client/reducers/index.ts ***!
  \**************************************/
/*! no static exports found */
...
var tasklistList_1 = __webpack_require__(/*! ./tasklistList */ "./app/client/reducers/tasklistList.ts");
var rootReducer = redux_1.combineReducers({
    tasklistList: tasklistList_1.tasklistList
});
...
/***/ "./app/client/reducers/tasklistList.ts":
/*!*********************************************!*\
  !*** ./app/client/reducers/tasklistList.ts ***!
  \*********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var constants = __importStar(__webpack_require__(/*! ../constants */ "./app/client/constants/index.ts"));
// import * as types from '../types';
var initialState = {
    items: {},
    isFetching: false
};
var tasklistList = function (state, action) {
    if (state === void 0) { state = initialState; }
    switch (action.type) {
        case constants.TASKLIST_LIST_FETCH:
            return __assign({}, state, { isFetching: true });
        case constants.TASKLIST_LIST_FETCH_SUCCESS:
            return __assign({}, state, { items: action.payload.items, isFetching: false });
    }
};
exports.tasklistList = tasklistList;


/***/ }),

/***/ "./app/client/store/configureStore.ts":
/*!********************************************!*\
  !*** ./app/client/store/configureStore.ts ***!
  \********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var redux_1 = __webpack_require__(/*! redux */ "./node_modules/redux/es/redux.js");
var reducers_1 = __importDefault(__webpack_require__(/*! ../reducers */ "./app/client/reducers/index.ts"));
